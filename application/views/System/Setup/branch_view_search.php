                ...
                <div class="orders">
                    ...
                    <?php if (isset($pageCount) && $pageCount > 1 && !empty($result)) { ?>
                        ...
                        <ul class="pagination justify-content-end" style="margin-right:10px;">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url();?>Admin/Branch/search/<?php echo $currentPage-1;?>/<?php echo $perPage;?>/<?php echo $search;?>" >Previous</a>
                            </li>
                            <?php } ?>
                            <?php for ($i=1; $i<=$pageCount; $i++) {
                                $class = ($i == $currentPage) ? 'active' : ''; ?>
                                <li class="page-item <?php echo $class?>">
                                    <a class="page-link " href="<?php echo base_url(); ?>Admin/Branch/search/<?php echo $i; ?>/<?php echo $perPage;?>/<?php echo $search;?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php
                            ...
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url();?>Admin/Branch/search/<?php echo $currentPage+1; ?>/<?php echo $perPage;?>/<?php echo $search;?>">Next</a>
                            </li>
                            <?php } ?>
                        </ul>
                    <?php } ?>
