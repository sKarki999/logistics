                ...
                <div class="orders">
                                            ...
                                            <tbody>
                                                ...
                                                <tr> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url();?>Admin/User/deleteUser/<?php echo $user['user_id']?>" class="btn btn-secondary btn-sm" onclick="if (!confirm('Are you sure?')) { return false }"> Del </a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                <?php $i = $i + 1; } ?>
                    ...
                    <?php if (isset($pageCount) && $pageCount > 1 && !empty($result)) { ?>
                        ...
                        <ul class="pagination justify-content-end" style="margin-right:10px;">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url();?>Admin/User/index/<?php echo $currentPage-1;?>/<?php echo $perPage;?>" >Previous</a>
                            </li>
                            <?php } ?>
                            <?php for ($i=1; $i<=$pageCount; $i++) {
                                $class = ($i == $currentPage) ? 'active' : ''; ?>
                                <li class="page-item <?php echo $class?>">
                                    <a class="page-link " href="<?php echo base_url(); ?>Admin/User/index/<?php echo $i; ?>/<?php echo $perPage;?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php
                            ...
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url();?>Admin/User/index/<?php echo $currentPage+1; ?>/<?php echo $perPage;?>">Next</a>
                            </li>
                            <?php } ?>
                        </ul>
                    <?php } ?>
