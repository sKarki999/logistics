        ...
        <div class="content">
            ...
            <section class="content" style="background: RGB(273, 267, 240);">
                <ul class="nav nav-pills nav-fill">
                    <li class="nav-item">
                        <a href="" class="btn btn-sm" style="background: #efe6cd;color:black;font-size:15px;">
                                        ...
                                        <table class="table table-striped table-bordered" id="invoiceTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr> 
                                                    ...
                                                    <td>
                                                        <?php
                                                            if($booking['cross_number'] != null) {
                                                                echo $booking['cross_number'];
                                                            } else {
                                                                echo '---';
                                                            }
                                                        ?>
            ...
            <?php if (isset($pageCount) && $pageCount > 0 && !empty($result)) { ?>
                <ul class="pagination float-right" style="margin-right:10px;">
                    <?php if ($currentPage > 1) { ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo base_url();?>Branch/Booking/index/<?php echo $currentPage-1;?>/<?php echo $perPage;?>" >Previous</a>
                    </li>
                    <?php } ?>
                    <?php for ($i=1; $i<=$pageCount; $i++) {
                        $class = ($i == $currentPage) ? 'active' : ''; ?>
                        <li class="page-item <?php echo $class?>">
                            <a class="page-link " href="<?php echo base_url(); ?>Branch/Booking/index/<?php echo $i; ?>/<?php echo $perPage;?>">
                                <?php echo $i; ?>
                            </a>
                        </li>
                    <?php
                    ...
                    <li class="page-item">
                        <a class="page-link" href="<?php echo base_url();?>Branch/Booking/index/<?php echo $currentPage+1; ?>/<?php echo $perPage;?>">Next</a>
                    </li>
                    <?php } ?>
                </ul>
            <?php } ?>
