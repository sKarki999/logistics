    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">                
                <div class="card my-4">
                    <div class="card-body">
                        <form method="post" action="<?php echo base_url();?>Branch/Customer/updateCustomer/<?php echo $customer['0']['customer_id'];?>">                            
                            <div class="form-group">
                                <label for=""><h5 class="required font-weight-bold">Customer Name </h5></label>
                                <input type="text" class="form-control" name="customer_name" 
                                value = "<?php echo (isset($customer['0']['customer_name'])) ? $customer['0']['customer_name'] : '' ; ?>" required/>
                            </div>

                            <div class="form-group">
                                <label for=""><h5 class="required font-weight-bold">Address </h5></label>
                                <input type="text" class="form-control" name="address" 
                                value = "<?php echo (isset($customer['0']['address'])) ? $customer['0']['address'] : '' ; ?>" required />
                            </div>

                            <div class="form-group">
                                <label for=""><h5 class="required font-weight-bold">Contact </h5></label>
                                <input type="text" class="form-control" name="contact_number" 
                                value = "<?php echo (isset($customer['0']['contact_number'])) ? $customer['0']['contact_number'] : '' ; ?>" required/>
                            </div>

                            <div class="form-group">
                                <label for=""><h5 class="required font-weight-bold">Email </h5></label>
                                <input type="text" class="form-control" name="email" 
                                value = "<?php echo (isset($customer['0']['email'])) ? $customer['0']['email'] : '' ; ?>" required/>
                            </div>

                            <div class="form-group">
                                <label for=""><h5 class="required font-weight-bold">Username </h5></label>
                                <input type="text" class="form-control" name="username" 
                                value = "<?php echo (isset($customer['0']['cu_user'])) ? $customer['0']['cu_user'] : '' ; ?>" required/>
                            </div>

                            <div class="form-group">
                                <label for=""><h5 class="required font-weight-bold">User Password </h5></label>
                                <input type="text" class="form-control" name="password" 
                                value = "<?php echo (isset($customer['0']['cu_password'])) ? $customer['0']['cu_password'] : '' ; ?>" required/>
                            </div>
